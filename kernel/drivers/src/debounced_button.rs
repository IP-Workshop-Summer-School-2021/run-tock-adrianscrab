...
// use crate::driver;
pub const DRIVER_NUM: usize = 0xa000e;
...
pub struct DebouncedButton<'a, P: gpio::InterruptPin<'a>> {
    pins: &'a [(
...
impl<'a, P: gpio::InterruptPin<'a>> DebouncedButton<'a, P> {
    pub fn new(
        pins: &'a [(
            &'a gpio::InterruptValueWrapper<'a, P>,
            gpio::ActivationMode,
...
impl<'a, P: gpio::InterruptPin<'a>> SyscallDriver for DebouncedButton<'a, P> {
...
impl<'a, P: gpio::InterruptPin<'a>> gpio::ClientWithValue for DebouncedButton<'a, P> {
